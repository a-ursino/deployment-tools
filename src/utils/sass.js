...
function compileSassAsync({ srcFolder, outputFolder, filename, cdnDomain, minify = false, projectName, stylelintrc, styledocPath, doiuseRules, autoprefixerRules }) {
	...
	return compileStylesheetAsync({ srcFolder, outputFolder, filename, cdnDomain, minify, projectName, engine: sass, stylelintrc, styledocPath, doiuseRules, autoprefixerRules });
}
